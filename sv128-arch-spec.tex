...
\lfoot{\textbf{SV128 0.0.3}}  % -- classification
...
\begin{tabular}{l r}
Date: & \today \\
Version: & 0.0.3 \\ % Date the experiment was performed
...
\begin{versionhistory}
  \vhEntry{0.0.3}{02.04.2019}{SWallach}{Adding AppendixB: Domain Calls, Return and Shadow Stack}
